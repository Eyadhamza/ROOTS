    ...
    <form action="/articles" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap ">
            <div class="md:w-1/2 pr-4 pl-4">
                ...
                <div class="mb-4">
                    <div class="mb-4">
                        <textarea name="description" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded mt-3" placeholder="Your Article *" style="width: 700px; height: 150px;"></textarea>
                    </div>
