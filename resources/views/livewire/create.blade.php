<div class=" bg-gray-900  ">
    <div class="panel-heading ">
        <h3 class="panel-title text-white flex justify-center">Here you can create a new User</h3>
    </div>
...
{{--            </div>--}}
            ...
            <div class="relative flex items-stretch w-full m-6">
                <br>
                <button wire:click="store()" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline btn-default ">  Save</button>
            </div>
{{--            committess--}}
