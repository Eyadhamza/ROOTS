...
<div class=" mx-auto">
    ...
    <div class="p-2 w-full mx-auto ">
        <p class ="mx-auto text-2xl text-blue-800 m-4 flex justify-center lg:text-4xl"> Search articles </p>
        ...
        <div class="absolute z-10 flex flex-col pl-0 mb-0 border rounded-lg border-gray-300 bg-white w-1/6 rounded-lg shadow-lg ">
            @if(!empty($articles))
                @foreach($articles as $article)
                    ...
                    <li class=" p-2 bg-blue-500 text-black border-2 border-blue-200 rounded-lg">   <a href="/article/{{$article->id}}" class="w-full font-bold text-white">
