        ...
        <div class="flex flex-wrap ">
            <div class="flex flex-wrap ">
                @foreach($user->articles as $article)
                    <div class="max-w-sm w-full lg:max-w-full lg:flex m-4 h-75 p-2">
                        <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url(/../../{{$article->image}})" title="Woman holding a mug">
                        </div>
