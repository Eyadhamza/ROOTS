...
@foreach($user->committees as $committee)
    <div class=" m-4  rounded-lg w-full lg:w-3/4 mx-auto mt-16">
        <div class="bg-blue-100 border-2 border-blue-800">
            ...
            <a  href="/committees/{{$committee->id}}/edit" class="w-full lg:w-1/2 mx-auto m-1 font-bold text-white inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-gray-900 flex justify-center ">
                Edit Committee.
            </a>
